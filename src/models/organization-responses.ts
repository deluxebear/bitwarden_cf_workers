...
import { advertiseOrganizationCapability } from '../services/server-capabilities';
...
export function toOrganizationResponse(org: any) {
    return {
        ...
        useKeyConnector: advertiseOrganizationCapability('keyConnector', org.useKeyConnector),
        useScim: advertiseOrganizationCapability('scim', org.useScim),
        useGroups: org.useGroups ?? false,
        useDirectory: advertiseOrganizationCapability('directory', org.useDirectory),
        useEvents: org.useEvents ?? true,
        useTotp: org.useTotp ?? true,
        use2fa: org.use2fa ?? true,
        useApi: advertiseOrganizationCapability('api', org.useApi ?? true),
        useResetPassword: org.useResetPassword ?? false,
        useSecretsManager: advertiseOrganizationCapability('secretsManager', org.useSecretsManager),
        ...
        useRiskInsights: advertiseOrganizationCapability('riskInsights', org.useRiskInsights),
        useOrganizationDomains: org.useOrganizationDomains ?? false,
        useAdminSponsoredFamilies: org.useAdminSponsoredFamilies ?? false,
        useAutomaticUserConfirmation: advertiseOrganizationCapability('automaticUserConfirmation', org.useAutomaticUserConfirmation),
        useInviteLinks: org.useInviteLinks ?? false,
        useDisableSmAdsForUsers: org.useDisableSmAdsForUsers ?? false,
        usePhishingBlocker: advertiseOrganizationCapability('phishingBlocker', org.usePhishingBlocker),
...
export function toProfileOrganizationResponse(
    ...
    return {
        ...
        useAutomaticUserConfirmation: advertiseOrganizationCapability('automaticUserConfirmation', org.useAutomaticUserConfirmation),
        useInviteLinks: toJsonBool(org.useInviteLinks),
        ...
        accessSecretsManager: advertiseOrganizationCapability('secretsManager', orgUser.accessSecretsManager),
